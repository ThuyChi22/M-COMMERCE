...
import com.tranduythanh.adapter.ProductAdapter;
import com.tranduythanh.models.ListProduct;

public class AdvanceProductManagementActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_advance_product_management);
    ...
    private void addViews() {
        ...
        adapter=new ProductAdapter(AdvanceProductManagementActivity.this, R.layout.item_advanced_product);

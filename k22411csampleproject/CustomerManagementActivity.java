...
import com.tranduythanh.models.CustomerConnector;
...
public class CustomerManagementActivity extends AppCompatActivity {
    ...
    private void displayCustomerDetailActivity(Customer c) {
        Intent intent= new Intent(CustomerManagementActivity.this, CustomerDetailMainActivity.class);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        else if(item.getItemId()==R.id.menu_broadcast_adversting){
            Toast.makeText(CustomerManagementActivity.this, "Gửi quảng cáo tới khách hàng khách hàng", Toast.LENGTH_LONG).show();
        }
    ...
    private void process_save_customer(Customer c) {
        ...
        if(result==true)
        {
            ...
            // họ có nhu cầu sửa các thông tn khác, ví dụ:
            // địa chỉ, payment method...
            // sinh viên tự xử lý trg hopwj sửa thông tin
        }
        else
        {
